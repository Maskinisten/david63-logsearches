...
class admin_controller implements admin_interface
{
	...
	*/
	public function display_output()
	{
		...
		$action = $this->u_action . "&amp;$u_sort_param$keywords_param";

		$pagination	= $this->container->get('pagination');
		$start		= $pagination->validate_start($start, $this->config['topics_per_page'], $log_count);
		$pagination->generate_template_pagination($action, 'pagination', 'start', $log_count, $this->config['topics_per_page'], $start);
	...
	{
		return ($type > 0) ? $this->user->lang['SEARCH_SUCCESS'] : $this->user->lang['SEARCH_FAIL'];
	}
